...
# Telegram proxy (can be overridden via environment variables)
TELEGRAM_PROXY_URL = env("TELEGRAM_PROXY_URL", "http://hXZsbn:1wHmj3@45.130.131.214:8000")
...
MANUAL_TRACKER_CHAT_IDS = [-1003807116470]
DASHBOARD_ALLOWED_USER_IDS = [290350576, 1128912872, 5201430878]
SUPPORT_CALL_NOTIFICATIONS_CHAT_ID = -1003405927565
...
CONGRATULATION_MESSAGE_4 = """Отлично! Твое задание <lesson_name> принято трекером, так держать👏🏻 

🎬 За каждое принятое <u>обязательное задание</u> я буду выдавать тебе по одной хлопушке «Стоп, снято!» 

Когда ты наберешь все 10 хлопушек, тебе откроется доступ к подарку - Бонус «Тренды в контенте в 2026 году»🔥"""
